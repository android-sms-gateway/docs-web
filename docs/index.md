...
- **Support for Android 5.0 and above:** The application is compatible with Android 5.0 and later versions. [See Android 15 Note](./faq/general.md#does-the-app-support-android-15)
